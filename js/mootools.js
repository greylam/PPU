...
web build:
 - http://mootools.net/core/0a75cfee6d3f645cb5a217ebb6710c54

packager build:
 - packager build Core/Core Core/Array Core/Element Core/Element.Style Core/Element.Event Core/Fx Core/Fx.CSS Core/Fx.Tween Core/Fx.Morph Core/Fx.Transitions
...
n.borderColor[k]=n[m][k]=j[k]="rgb(@, @, @)";});})();(function(){var b={};var a=this.DOMEvent=new Type("DOMEvent",function(c,g){if(!g){g=window;}c=c||g.event;
...
}};}Element.Events=new Hash(Element.Events);})();(function(){var a=this.Class=new Type("Class",function(h){if(instanceOf(h,Function)){h={initialize:h};
